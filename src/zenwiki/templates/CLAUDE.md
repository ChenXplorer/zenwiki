...
3. If two concepts from different sources naturally compare → consider creating a `comparisons/` page
4. If a domain is gaining enough pages → consider creating or updating a `maps/` page
